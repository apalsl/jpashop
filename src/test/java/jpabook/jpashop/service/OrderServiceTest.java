...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Assert.assertEquals("주문 가격은ㅇ 가격 * 수량이다.", 10000 * orderCount, getOrder.getTotalPrice());
    ...
    public void 주문목록조회() throws Exception {
        ...
        for (Order order : orderList) {
            ...
            Assert.assertEquals("주문한 사람은 member와 동일하다.", member.getName(), order.getMember().getName());
        }


//        Assert.assertEquals("주문된 상품은 orderCount와 동일해야 한다.", orderCount, orderList.size());
